...
services:
  warp:
    ...
    environment:
      ...
      # - TUNNEL_TOKEN= # optional, if you have a tunnel token, you can use it
warp-cli connect
    cap_add:
...
- `TUNNEL_TOKEN`: If you have a TUNNEL_TOKEN from cloudflare it can be used. the WARP_LICENCE_KEY is ignored in this case.
